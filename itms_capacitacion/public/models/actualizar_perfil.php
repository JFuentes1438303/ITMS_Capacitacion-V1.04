          ...
          <ul class="navbar-nav list-group-item-action">
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                <a class="dropdown-item" href="../views/subir_curso.php">Subir curso</a>
                <a class="dropdown-item" href="../views/mis_cursos.php">Mis cursos</a>
                <a class="dropdown-item" href="actualizar_perfil.php">Actualizar perfil</a>
                <hr>
            ...
            <div class="container div color2">
              ...
              <form action="../controllers/perfil.php" method="POST">
                ...
                <div class="row espacio2 negrilla">
                  ...
                  <div class="col-sm-3 t_centro">
                    <input type="text" id="nombres" class="form-control inputs" name="nombres" autocomplete="off" value="<?php echo $nnombres ?>">
                  </div>
                  <div class="col-sm-2 t_centro espacio2">
                    Apellidos
                  </div>
                  <div class="col-sm-4 t_centro">
                    <input type="text" id="apellidos" class="form-control inputs" name="apellidos" autocomplete="off" value="<?php echo $aapellidos ?>">
                  </div>
                </div>
                ...
                <div class="row espacio2">
                  ...
                  <div class="col-sm-9 t_centro">
                    <input type="text" id="correo" class="form-control inputs" name="correo" autocomplete="off" value="<?php echo $ccorreo ?>">
                  </div>
                </div>
                <br>
